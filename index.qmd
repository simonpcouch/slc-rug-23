...
![](figures/unfairness_1.png){.absolute top="100" left="20" width="600"}

. . .

![](figures/unfairness_2.png){.absolute top="150" left="120" width="600"}

. . .

![](figures/unfairness_3.png){.absolute top="200" left="220" width="600"}
...
![](figures/failures_1.png){.absolute top="100" left="20" width="600"}

. . .

![](figures/failures_2.png){.absolute top="150" left="120" width="600"}

. . .

![](figures/failures_3.png){.absolute top="200" left="220" width="600"}
...
**Position**: it is unfair to incorrectly classify human-written text as AI-generated
...
**Position**: it is unfair to pass on an essay written by a GPT as one's own work **and** it is unfair to incorrectly classify human-written text as AI-generated.
...
# Choosing a detector {background-color="#CA225E"}
